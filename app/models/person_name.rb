...
class PersonName < ActiveRecord::Base
  ...
  def before_save
    ...
    #  :given_name_code => Text::Soundex.soundex(self.given_name || ''),
    #  :middle_name_code => Text::Soundex.soundex(self.middle_name || ''),
    #  :family_name_code => Text::Soundex.soundex(self.family_name || ''),
    #  :family_name2_code => Text::Soundex.soundex(self.family_name2 || ''),
    #  :family_name_suffix_code => Text::Soundex.soundex(self.family_name_suffix || ''))
  end
